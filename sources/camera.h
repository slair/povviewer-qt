...
class Camera : public QObject {
	...
	Q_PROPERTY(QWindowPointer window READ window WRITE setWindow
			   NOTIFY windowChanged)
	Q_PROPERTY(float cameraSpeed READ cameraSpeed WRITE setCameraSpeed
			   NOTIFY cameraSpeedChanged)
...
public:
	...
	QWindowPointer window() const noexcept {
		return m_window;
	}
	...
	float cameraSpeed() const noexcept {
	...
	QVector3D front() const noexcept {
